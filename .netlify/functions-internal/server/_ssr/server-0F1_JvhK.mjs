...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CXWoe5X2.mjs");
...
const manifest = {
  "5e7bc6b7985a4c5567ec29c826f97eeb7805c320edefacaaf2df3b19b86050da": {
    ...
    importer: () => import("./analytics.functions-DJD9hl0_.mjs")
  },
  "01280a291b7cbd85c4b21ee7bb86362f9a00be3ea19e8b70cccfd6cecac70a6d": {
    functionName: "trackClick_createServerFn_handler",
    importer: () => import("./analytics.functions-DJD9hl0_.mjs")
  },
  "c491f292fda3d5d830370f062a74d0bc23cfc38facc1346ab53630f9411951c8": {
  ...
  "8b404eadc272d7d27f48745f2fd105c6bc74772c80d7e5eb87638d43cd197daa": {
    ...
    importer: () => import("./admin.functions-DDcRbEBw.mjs")
  },
  "d9425d3c7a250d7701d286efd0414683dc977e4fa309b10da0ac77fcbe4e9e2c": {
    functionName: "claimFirstAdmin_createServerFn_handler",
    importer: () => import("./admin.functions-DDcRbEBw.mjs")
  },
  "44d880232a871616b36fad6ca0bbea7332a21320a6e09f57c552f0b06699ff94": {
    functionName: "listNews_createServerFn_handler",
    importer: () => import("./news.functions-DdxJhP6v.mjs")
  },
  "438c85bf852bff59e855217e018909073acd1513b38f3c747c1462d984225c3a": {
    functionName: "upsertNews_createServerFn_handler",
    importer: () => import("./news.functions-DdxJhP6v.mjs")
  },
  "d1d7c8f80ff01cce25991e870f7a00ef2ee2863fb1a7266bb183f1f4a6aa10aa": {
  ...
  "1ac20e83585a55e943670fa4670b07889b610801a7a21f28dc367c19f92e50fd": {
    ...
    importer: () => import("./contact.functions-CEH2Ra2f.mjs")
  },
  "ebbf61dd63bb7b3a20c3bf5cc319e5305ac50841f4fb07455ad177d553535c67": {
    functionName: "listMessages_createServerFn_handler",
    importer: () => import("./contact.functions-CEH2Ra2f.mjs")
  },
  "63553628c39c49bae2f67d1126b02516291fdee1ed74796758aafa558b3a7f25": {
    functionName: "markMessageRead_createServerFn_handler",
    importer: () => import("./contact.functions-CEH2Ra2f.mjs")
  },
  "a6974f2963616d2c3b0e660601e11790bd00aad78f2fad325cf6ad99631a2084": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DeVYuCpg.mjs").then((n) => n.r),
    import("./start-D91ws0GO.mjs"),
